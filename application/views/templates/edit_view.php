...
<div class="space-y-6">
    ...
    <div id="template-app" v-cloak>
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-0.5">
                        <span class="text-teal-600 font-medium">{{ form.nama_sk }}</span>
                        <span class="mx-2 text-slate-300">•</span>
                        <span>ID: <?php echo $template->id; ?></span>
                    </p>
                </div>
            </div>
        ...
        <form id="template-form" method="POST" action="<?php echo site_url('templates/update/' . $template->id); ?>" style="display: none;">
    ...
    createApp({
        setup() {
            const form = ref({
                ...
                kategori: TEMPLATE_DATA.kategori || '',
